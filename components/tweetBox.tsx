...
function TweetBox({setTweets}:Props) {
  ...
  const postTweet = async () =>{
    const tweetInfo: TweetBody = {
      ...
      profileImg: session?.user?.image || 'https://www.seekpng.com/png/detail/966-9665317_placeholder-image-person-jpg.png',
      image:image,
    }
  ...
  return (
    <div className="flex space-x-2 p-5">
      <img
        ...
        src={session?.user?.image || "https://www.seekpng.com/png/detail/966-9665317_placeholder-image-person-jpg.png"}
      ></img>
      ...
      <div className="flex flex-1 items-center pl-2">
        <form className="flex flex-1 flex-col">
          ...
          <div className="flex items-center">
            <div className="flex flex-1 space-x-2 text-gwitter">
              {/* Icons */}
            ...
            <button
              ...
              className="bg-gwitter text-white px-5 py-2 font-bold rounded-full disabled:opacity-40"
            >
              Tweet
            </button>
          </div>
          ...
          {imageUrlBoxIsOpen && (
            <form className="mt-5 flex rounded-lg bg-gwitter/80 py-2 px-4">
